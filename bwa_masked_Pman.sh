...
THREADS=40  #Line 9 sets this up to run 20 processors.  If you want fewer, make sure to change that line as well as this one.
...
#	MINLEN:33
	...
	for FASTQ in $RAW_READS_HOME/$ABBREV*.fastq
...
for RAW_READ_FILE in $WORKDIR/data_links/*_L001_R1_001.fastq
